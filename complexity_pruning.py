...
dashboard['left'].text(.022, .915, '(a)', transform=dashboard['left'].transAxes, fontsize=30, bbox=props)
dashboard['right'].text(.022, .915, '(b)', transform=dashboard['right'].transAxes, fontsize=30, bbox=props)
